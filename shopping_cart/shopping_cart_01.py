...
class Corzina:
    ...
    def add_item(self, item:Product) -> list[Product]:  # добавление продукта в корзину
    ...
    def max_price(self)->str:
        ...
        return print(name_max_price)


item1 = Product('арбуз', 5.00, 3.20)
...
c = Corzina(0.03, 5.0, product_list)
c.clear_corzina()
c.add_item(item5)
c.add_item(item4)
c.add_item(item3)
